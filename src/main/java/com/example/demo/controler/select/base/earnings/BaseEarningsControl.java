...
import com.example.demo.repository.select.base.earnings.BaseEarningsMapper;

public class BaseEarningsControl {//extends
	protected BaseEarningsMapper datebaceMapper;
	protected String groupItemName;
	protected String groupItemTypeName;
	protected String selectUrl;
	
	public BaseEarningsControl() {
		datebaceMapper = null;
		groupItemName = null;

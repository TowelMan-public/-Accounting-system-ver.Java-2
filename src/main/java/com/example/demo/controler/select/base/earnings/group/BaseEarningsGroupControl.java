...
import com.example.demo.repository.select.base.earnings.group.BaseEarningsGroupMapper;

public class BaseEarningsGroupControl {	
	protected BaseEarningsGroupMapper datebaceMapper;
	protected String groupItemName;
	protected String groupItemTypeName;
	protected String selectUrl;
	
	public BaseEarningsGroupControl() {
		datebaceMapper = null;
		groupItemName = null;
